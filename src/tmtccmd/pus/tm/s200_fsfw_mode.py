...
class Service200FsfwTm(PusTmBase, PusTmInfoBase):
    ...
    def __empty(cls) -> Service200FsfwTm:
        return cls(subservice_id=0, object_id=bytearray(4), time=CdsShortTimestamp.empty())
    ...
    def unpack(
        ...
        service_200_tm.pus_tm = PusTelemetry.unpack(data=raw_telemetry, time_reader=time_reader)
