...
from tmtccmd.ecss.tc import insert_default_apid
...
def set_default_globals_post_args_parsing(
    ...
    :param custom_com_ifs_lists:
    List of collections or dictionaries containing customcommunication interfaces
    :return:
    """
