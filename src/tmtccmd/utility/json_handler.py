...
class JsonKeyNames(enum.Enum):
    TCPIP_DEST_IP_ADDRESS = "TCPIP_DEST_IP_ADDRESS"
    TCPIP_DEST_PORT = "TCPIP_DEST_PORT"
    TCPIP_RECV_IP_ADDRESS = "TCPIP_RECV_IP_ADDRESS"
    TCPIP_RECV_PORT = "TCPIP_RECV_PORT"
    TCPIP_RECV_MAX_SIZE = "TCPIP_RECV_MAX_SIZE"
