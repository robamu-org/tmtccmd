...
from tmtccmd.pus.pus_5_event import Subservices
...
class Service5Tm(PusTmBase, PusTmInfoBase):
    ...
    def __empty(cls) -> Service5Tm:
        return cls(
            subservice=Subservices.INFO_EVENT,
            event_id=0,
    ...
    def __init_without_base(instance: Service5Tm, set_attrs_from_tm_data: bool = False):
        ...
        if instance.subservice == Subservices.INFO_EVENT:
            instance.append_packet_info(" Info")
        elif instance.subservice == Subservices.LOW_SEVERITY_EVENT:
            instance.append_packet_info(" Error Low Severity")
        elif instance.subservice == Subservices.MEDIUM_SEVERITY_EVENT:
            instance.append_packet_info(" Error Med Severity")
        elif instance.subservice == Subservices.HIGH_SEVERITY_EVENT:
