...
class PusTmInfoBase(PusTmInfoInterface):
    ...
    def append_telemetry_content(self, content_list: list):
        ...
        content_list.append(f"{self.pus_tm.pus_tm_sec_header.time.return_unix_seconds()}")
        content_list.append(f"{self.pus_tm.pus_tm_sec_header.time.return_time_string()}")
