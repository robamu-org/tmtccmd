...
def pack_generic_service5_test_into(q: QueueHelper, apid: int = -1):
    ...
    q.add_pus_tc(PusTelecommand(service=5, subservice=1, apid=apid, ssc=500))
    # disable events
    ...
    q.add_pus_tc(PusTelecommand(service=17, subservice=128, apid=apid, ssc=510))
    # enable event
    ...
    q.add_pus_tc(PusTelecommand(service=17, subservice=128, apid=apid, ssc=530))
